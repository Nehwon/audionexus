...
api_router.include_router(
    audiobookshelf_router, prefix="/audiobookshelf", tags=["audiobookshelf"]
)
api_router.include_router(
    audiobookshelf_instances_router, prefix="", tags=["audiobookshelf-instances"]
)
api_router.include_router(
    audiobookshelf_sync_router, prefix="", tags=["audiobookshelf-sync"]
)
api_router.include_router(
    audiobookshelf_local_router, prefix="", tags=["audiobookshelf-local"]
)
api_router.include_router(
    audiobookshelf_upload_router, prefix="/upload", tags=["upload"]
)
